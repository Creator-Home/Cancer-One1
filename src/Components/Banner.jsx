...
function Banner() {
  return (
    <>
       <div className="w-full p-20 bg-white-100  ">
            <div className="flex flex-col  justify-center">
              <h1 className='absolute flex items-end text-pink-500  font-normal font-AksaraBaliGalang text-5xl'>Diagnose. Recover.</h1>
               ...
               <div>
                <p className='absolute my-24 mx- 4 text-pink-500  font-normal flex items-end'>Extending a proactive helping hand to Breast Cancer <br/> patients on their recovery journey.</p>
               </div>
